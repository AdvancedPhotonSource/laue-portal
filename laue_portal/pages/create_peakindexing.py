...
def submit_parameters(
    ...
    try:
        fields = {
            ...
            "max_peaks": parse_parameter(max_peaks, num_inputs),
    ...
    for index, identity in enumerate(identities):
        ...
        try:
            ...
            request = LaueGoIndexingRequest(
                ...
                max_number=(
                    int(fields["max_number"][index]) if fields["max_number"][index] not in (None, "") else None
                ),
                ...
                min_size=int(float(fields["min_size"][index])),
                max_peaks=(int(fields["max_peaks"][index]) if fields["max_peaks"][index] not in (None, "") else 200),
            ...
            try:
                if indexing_id is not None:
                    ...
                    if reconstruction_id is not None:
                        ...
                        form_data.data_path = remove_root_path_prefix(input_path, root_path)
