    ...
    [
        ...
        html.Div(
            [
                                ...
                                dbc.Row(
                                    [
                                        dbc.Col(
                                            [
                                                html.P(
                                                    children=[html.Strong("Status: "), html.Div(id="Status_print")],
                                                    style={"display": "flex", "gap": "5px", "align-items": "flex-end"},
                                                ),
                                                html.P(
                                                    children=[html.Strong("Priority: "), html.Div(id="Priority_print")],
                                                    style={"display": "flex", "gap": "5px", "align-items": "flex-end"},
                                                ),
                                                html.P(
                                                    children=[html.Strong("Computer: "), html.Div(id="Computer_print")],
                                                    style={"display": "flex", "gap": "5px", "align-items": "flex-end"},
                                                ),
                                            ],
                                            width=6,
                                        ...
                                        dbc.Col(
                                            [
                                                html.P(
                                                    children=[
                                                        html.Strong("Submit Time: "),
                                                        html.Div(id="SubmitTime_print"),
                                                    ],
                                                    style={"display": "flex", "gap": "5px", "align-items": "flex-end"},
                                                ),
                                                html.P(
                                                    children=[
                                                        ...
                                                        html.Div(id="StartTime_print"),
                                                    ],
                                                    style={"display": "flex", "gap": "5px", "align-items": "flex-end"},
                                                ),
                                                html.P(
                                                    children=[
                                                        html.Strong("Finish Time: "),
                                                        html.Div(id="FinishTime_print"),
                                                    ],
                                                    style={"display": "flex", "gap": "5px", "align-items": "flex-end"},
                                                ),
                                                html.P(
                                                    children=[html.Strong("Duration: "), html.Div(id="Duration_print")],
                                                    style={"display": "flex", "gap": "5px", "align-items": "flex-end"},
                                                ),
                                            ],
                                            width=6,
                ...
                dbc.Card(
                    [
                        dbc.CardHeader(html.H4("SubJob Output", className="mb-0"), className="bg-light"),
                        dbc.CardBody(
                            [
                                html.Div(
                                    id="subjob-output-content",
                                    children=[html.P("No output available for this job.", className="text-muted")],
                                )
                            ]
                        ),
                    ],
                    ...
                    if calib_data:
                        related_links.append(
                            html.Span(
                                [
                                    html.A(
                                        f"Calibration ID: {calib_data.calib_id}",
                                        href=f"/calibration?calib_id={calib_data.calib_id}",
                                    ),
                                    " | ",
                                    html.A(
                                        f"Scan ID: {calib_data.scanNumber}",
                                        href=f"/scan?scan_id={calib_data.scanNumber}",
                                    ),
                                ]
                            )
                        )
