...
from laue_portal.components.lauematching_form2 import lauematching_form
...
layout = dbc.Container(
    [html.Div([
        navbar.navbar,
        dcc.Location(id='url-create-lauematching', refresh=False),
        dbc.Alert(
            "Hello! I am an alert",
            id="alert-upload",
            dismissable=True,
        ...
        dbc.Row(
                [
                    dbc.Col(
                        html.H3(id="peakindex-title", children="New LaueMatching"),
...
# @dash.callback(
#     Input('url-create-lauematching', 'href'),
#     prevent_initial_call=True,
# )
...
#     URL format: /create-lauematching?scan_id={scan_id}
#     Pooled URL format: /create-lauematching?scan_id={scan_ids}
#     With recon_id: /create-lauematching?scan_id={scan_id}&recon_id={recon_id}
#     With wirerecon_id: /create-lauematching?scan_id={scan_id}&wirerecon_id={wirerecon_id}
#     With peakindex_id: /create-lauematching?scan_id={scan_id}&peakindex_id={peakindex_id}
#     With both recon_id and peakindex_id: /create-lauematching?scan_id={scan_id}&recon_id={recon_id}&peakindex_id={peakindex_id}
#     """
#     if not href:
#         raise PreventUpdate
