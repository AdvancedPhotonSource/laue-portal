...
def set_recon_form_props(recon, read_only=False):
    ...
    set_props("data_stacked", {'checked':recon.file_stacked, 'disabled':read_only})
    ...
    set_props("reversed", {'checked':recon.geo_mask_reversed, 'disabled':read_only})
    ...
    set_props("recon_sig", {'checked':recon.algo_sig_recon, 'disabled':read_only})
    ...
    set_props("recon_ene", {'checked':recon.algo_ene_recon, 'disabled':read_only})
    set_props("exact_ene", {'checked':recon.algo_ene_exact, 'disabled':read_only})
