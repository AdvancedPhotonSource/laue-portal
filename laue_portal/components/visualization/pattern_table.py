...
def make_pattern_table(patterns: list[dict]) -> html.Div:
    ...
    column_defs = [
        ...
        _num_col("X motor", "x_sample", 95, "d3.format('.3f')(params.value)", hide=True),
        _num_col("Y motor", "y_sample", 95, "d3.format('.3f')(params.value)", hide=True),
        _num_col("Z motor", "z_sample", 95, "d3.format('.3f')(params.value)", hide=True),
            ...
            html.Div(
                [
                    ...
                    dbc.Checklist(
                        ...
                        options=[
                            {"label": "X motor", "value": "x_sample"},
                            {"label": "Y motor", "value": "y_sample"},
                            {"label": "Z motor", "value": "z_sample"},
