...
class DownlinkIndex(GladierBaseTool):
    flow_definition = {
        'Comment': 'Transfer laue result data to APS systems',
        'StartAt': 'DownlinkIndex',
        'States': {
            'DownlinkIndex': {
                ...
                'Parameters': {
                    ...
                    'transfer_items': [
                        {
                            'source_path.$': '$.input.downlink_index_source_path',
                            'destination_path.$': '$.input.downlink_index_destination_path',
                            'recursive.$': '$.input.downlink_recursive',
                        }
                    ]
                },
                'ResultPath': '$.downlinkIndex',
                'WaitTime': 600,
                'End': True
            },
        }
