...
class TestMergeXmlFiles:
    ...
    def test_merge_single_file(self, tmp_path):
        ...
        create_test_xml(xml_dir / "test_1.xml", {"scanNum": "1", "Xsample": "100.0"})
    ...
    def test_merge_multiple_files(self, tmp_path):
        ...
        for i in range(5):
            create_test_xml(xml_dir / f"test_{i + 1}.xml", {"scanNum": str(i + 1), "Xsample": str(100.0 + i)})
    ...
    def test_merge_skips_malformed_xml(self, tmp_path):
        ...
        create_test_xml(xml_dir / "test_3.xml", {"scanNum": "3"})
